            ...
            <div className="w-full max-w-md relative">
                ...
                <div className="bg-white rounded-3xl p-10 shadow-[0_30px_100px_rgba(5,12,27,0.45)] border border-white/60">
                    ...
                    <button
                        ...
                        disabled={loading || googleLoading}
                        className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl border-2 border-gray-200 bg-white text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-60 disabled:cursor-not-allowed text-[15px]"
                    >
