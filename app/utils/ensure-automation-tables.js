...
export async function ensureAutomationTables() {
    ...
    ensuringPromise = (async () => {
        ...
        // Payment confirmations table for tracking Stripe payments
        await query(`
        ...
        await query(`
            CREATE INDEX IF NOT EXISTS idx_payment_confirmations_session ON payment_confirmations(session_id)
        `);
        await query(`
            CREATE INDEX IF NOT EXISTS idx_payment_confirmations_intent ON payment_confirmations(payment_intent_id)
        `);
