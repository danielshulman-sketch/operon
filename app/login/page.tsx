  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      ...
      <button
        ...
        disabled={loading || googleLoading}
        className="w-full py-2.5 rounded border-2 border-slate-300 bg-white text-slate-700 font-semibold hover:bg-slate-50 hover:border-slate-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="max-w-md mx-auto text-center py-10">Loading...</div>}>
      <LoginPageContent />
    </Suspense>
  );
}
